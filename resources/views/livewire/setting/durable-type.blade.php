<div>
                            ...
                            <tr class="text-nowrap">
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                        <button wire:click="EditDurable('{{ $commo->com_type_id }}')" class="name-button btn btn-info btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal1" >แก้ไข</button>
                                        <button class="btn btn-danger btn-sm" data-confirm-delete="true">ลบ</button>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
                    ...
                    <form wire:submit.prevent='storeDurableData'>
                        <div class="form-floating mb-3">
                            <input type="input" class="form-control  @error('durable_type') is-invalid @enderror"
                                id="durable_type" wire:model.blur="durable_type" placeholder="">
    ...
    {{-- edit --}}
    <div wire:ignore.self class="modal fade" data-bs-backdrop="static" id="exampleModal1" tabindex="-1"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
