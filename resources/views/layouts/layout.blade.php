...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('uipack/assets/img/favicon/favicon.ico') }}" />
    <!-- Fonts -->
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        ...
                        <span class="app-brand-text fs-4 menu-text text-uppercase fw-bolder ms-2">Inv-Durables</span>
                    </a>
