                ...
                <table class="table table-bordered text-center table-striped" id="datatable1">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="text-center text-nowrap">ครุภัณฑ์</th>
                    ...
                    <form class="" action="{{ route('daruble_add') }}" method="POST">
                        ...
                        <div class="form-floating mb-3">
                            <input type="input" name="commoid"
                                class="form-control @error('commoid') is-invalid @enderror" id="commoid"
                                placeholder="" value="{{ old('commoid') }}">
                        ...
                        <div class="form-floating mb-3">
                            <input type="number" name="year" class="form-control" id="year"
                                placeholder="" value="{{ old('year') }}">
                            <label for="year" class="text-dark">ปีที่ได้รับ</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="number" name="ip" class="form-control" id="ip"
                                placeholder="" value="{{ old('ip') }}">
                            <label for="ip" class="text-dark">Anydesk</label>
                        </div>
                        <div class="form-floating mb-3">
