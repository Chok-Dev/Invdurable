...
<head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('uipack/assets/vendor/css/pages/page-auth.css') }}" />
    <!-- Helpers -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">Inv-Durables</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('register') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="name" class="form-label fs-5">ชื่อผู้ใช้</label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="name" name="name" value="{{ old('name') }}" placeholder="กรอกชื่อผู้ใช้" autofocus />
                                @error('name')
                            ...
                            <div class="mb-3 form-password-toggle">
                                <label class="form-label fs-5" for="password">รหัสผ่าน</label>
                            ...
                            <div class="mb-3 form-password-toggle">
                                <label class="form-label fs-5" for="password">ยืนยัน รหัสผ่าน</label>
                                <div class="input-group input-group-merge">
                            ...
                            <button class="btn btn-primary d-grid w-100">สมัคร</button>
                        </form>

                        <p class="text-center">
                            <span>คุณมีบัญชีผู้ใช้แล้ว?</span>
                            <a href="{{ route('login') }}">
